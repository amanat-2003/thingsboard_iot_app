...
const Map<AlarmSeverity, Color> alarmSeverityColorsDark = {
  AlarmSeverity.CRITICAL: Color.fromARGB(255, 255, 52, 150),
  AlarmSeverity.MAJOR: Color.fromARGB(255, 77, 169, 255),
  AlarmSeverity.MINOR: Color.fromARGB(255, 194, 61, 255),
  AlarmSeverity.WARNING: Color.fromARGB(255, 255, 187, 0),
  AlarmSeverity.INDETERMINATE: Color(0xFF00FF00),
};

const Map<AlarmSeverity, Color> alarmSeverityColorsLight = {
  AlarmSeverity.CRITICAL: Color(0xFFFF0000),
  AlarmSeverity.MAJOR: Color.fromARGB(255, 17, 0, 255),
  AlarmSeverity.MINOR: Color.fromARGB(255, 163, 0, 238),
  AlarmSeverity.WARNING: Color.fromARGB(255, 201, 147, 0),
  AlarmSeverity.INDETERMINATE: Color.fromARGB(255, 0, 206, 0),
};
      ...
      return Card(
        ...
        child: Container(
          decoration: BoxDecoration(
            color: isDarkMode(context)
                ? AppColors.tertiaryContainerDarkMode
                : AppColors.tertiaryContainerLightMode,
                                      ...
                                      Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                                ...
                                                style: TextStyle(
                                                    color: isDarkMode(context)
                                                        ? alarmSeverityColorsDark[
                                                            AlarmSeverity
                                                                .MAJOR]!
                                                        : alarmSeverityColorsLight[
                                                            alarm.severity]!,
